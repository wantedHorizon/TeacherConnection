...
public class FriendsFrag extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mAccountsRV = (RecyclerView) view.findViewById(R.id.listMyFriends);
     ...
     //   mDatabase.keepSynced(true);
        ...
        DatabaseReference personRef=FirebaseDatabase.getInstance().getReference().child("Connections").child(myID);
...
/*
                    ...
                    holder.mView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                           ((MyConnections) getActivity()).onItemClicked(model, model.getuID());
